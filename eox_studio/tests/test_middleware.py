...
from eox_studio.middleware import PathRedirectionMiddleware, RedirectionsMiddleware
from eox_studio.models import Redirection
...
class PathRedirectionMiddlewareTest(TestCase):
    ...
    @mock.patch('eox_studio.middleware.PathRedirectionMiddleware.process_mktg_redirect')
    @mock.patch('eox_studio.middleware.PathRedirectionMiddleware.process_custom_path_redirect')
    @mock.patch('eox_studio.middleware.configuration_helper')
...
class RedirectionMiddlewareTest(TestCase):
    ...
    @mock.patch('eox_studio.models.Redirection.objects.get')
