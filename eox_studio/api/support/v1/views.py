...
from eox_studio.api.support.v1.permissions import EoxCoreSupportAPIPermission
from eox_studio.api.support.v1.serializers import WrittableEdxappRemoveUserSerializer, WrittableEdxappUsernameSerializer
from eox_studio.api.v1.serializers import EdxappUserReadOnlySerializer
from eox_studio.api.v1.views import UserQueryMixin
from eox_studio.edxapp_wrapper.bearer_authentication import BearerAuthentication
from eox_studio.edxapp_wrapper.comments_service_users import replace_username_cs_user
from eox_studio.edxapp_wrapper.users import delete_edxapp_user, get_edxapp_user
...
class EdxappUser(UserQueryMixin, APIView):
    ...
    def delete(self, request, *args, **kwargs):  # pylint: disable=too-many-locals
        ...
        **Requests**:
            DELETE <domain>/eox-studio/support-api/v1/user/
...
class EdxappReplaceUsername(UserQueryMixin, APIView):
    ...
    def patch(self, request, *args, **kwargs):
        ...
        **Requests**:
            PATCH <domain>/eox-studio/support-api/v1/replace-username/
